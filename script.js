...
function actionLogin() {
  ...
  if (email === '' || password === '') {
    alert('Email dan Password harus diisi semua ya!');
    return;
  }
...
function actionRegister() {
  ...
  var konfirmasi = document.getElementById('regKonfirmasi').value.trim();
  ...
  if (password !== konfirmasi) {
    alert('Konfirmasi password tidak cocok, coba lagi!');
    return;
  }
...
function updateNavState(id){
  var navMap = {
    ...
    successPage: 'Pesanan',
    statusPage: 'Pesanan'
    // profilePage udah dihapus dari sini karena tombolnya pindah ke atas
  };
  ...
  navButtons.forEach(function(btn){
    ...
    // Pake includes biar gampang nyocokin Icon + Text
    if(activeLabel && btn.innerText.includes(activeLabel)){
